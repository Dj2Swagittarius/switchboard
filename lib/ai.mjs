...
export const PROVIDERS = ['lmstudio', 'ollama', 'anthropic', 'openai'];
...
export const textModel = (p = provider()) => settings.get(modelKeys(p)[0]);
export const visionModel = (p = provider()) => settings.get(modelKeys(p)[1]);
